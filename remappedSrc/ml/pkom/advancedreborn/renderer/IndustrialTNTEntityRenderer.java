...
public class IndustrialTNTEntityRenderer extends EntityRenderer<IndustrialTNTEntity> {
    public IndustrialTNTEntityRenderer(EntityRenderDispatcher entityRenderDispatcher) {
    ...
    public void render(IndustrialTNTEntity entity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        if (entity.getFuseTimer() - g + 1.0F < 10.0F) {
            float h = 1.0F - (entity.getFuseTimer() - g + 1.0F) / 10.0F;
        ...
        matrixStack.multiply(Vec3f.POSITIVE_Y.getDegreesQuaternion(90.0F));
        TntMinecartEntityRenderer.renderFlashingBlock(Blocks.INDUSTRIAL_TNT.getDefaultState(), matrixStack, vertexConsumerProvider, i, entity.getFuseTimer() / 5 % 2 == 0);
        matrixStack.pop();
